                ...
                <tbody>
                    @foreach ($order->orderlines as $line)
                        <tr class="">
                            ...
                            <td class="py-2 text-right bg-gray-300 border-2 border-white"><x-pp v="{{ $line->item->net }}" /></td>
                            <td class="py-2 text-center bg-gray-300 border-2 border-white">{{ $line->item->vatrate }}</td>
