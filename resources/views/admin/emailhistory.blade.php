...
<div class="container mx-auto text-sm text-gray-700" x-data="{ effectivePermissions: false }">
    ...
    <table class="w-full mt-4 text-xs text-gray-800 bg-white border shadow-lg table-fixed">
        ...
        <tbody>
            ...
            <td class="px-2 py-1 text-center"><a href="{{ $email->pdf }}" target="_blank"><svg  class="inline-block h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
